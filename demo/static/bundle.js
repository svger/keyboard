...
module.exports = __webpack_require__.p + "images/98622a81.packUp.png";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__component__ = __webpack_require__(28);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(true){(function(){'use strict';var React=__webpack_require__(0);var invariant=__webpack_require__(1);var warning=__webpack_require__(2);var ExecutionEnvironment=__webpack_require__(16);var _assign=__webpack_require__(4);var emptyFunction$1=__webpack_require__(3);var EventListener=__webpack_require__(17);var getActiveElement=__webpack_require__(18);var shallowEqual=__webpack_require__(19);var containsNode=__webpack_require__(20);var focusNode=__webpack_require__(23);var emptyObject=__webpack_require__(5);var checkPropTypes=__webpack_require__(6);var hyphenateStyleName=__webpack_require__(24);var camelizeStyleName=__webpack_require__(26);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_Keyboard__ = __webpack_require__(29);
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.handleKeyPress = function (value) {
      console.log('handleKeyPress:', value);
    }, _this.handleKeyValueDelete = function () {
      console.log('handleKeyValueDelete');
    }, _this.handleHideKeyboard = function () {
      _this.setState({
        showKeyboard: false
      });
    }, _this.clearValue = function () {
      console.log('clearValue');
    }, _this.handleToggleKeyboard = function () {
      _this.setState({
        showKeyboard: !_this.state.showKeyboard
      });
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'button',
          { onClick: this.handleToggleKeyboard },
          'Show or hide Keyboard'
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__src_Keyboard__["a" /* default */], {
          type: 'stock',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__style_index_less__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var defaultPrefixCls = 'cefc-keyboard';
...
var Keyboard = function (_Component) {
  ...
  function Keyboard(props, context) {
    ...
    _this.renderStockItems = function () {
      ...
      var stockItemsCls = __WEBPACK_IMPORTED_MODULE_2_classnames___default()(prefixCls + '-digit-item', prefixCls + '-stock-digit-item');
      var actionCls = __WEBPACK_IMPORTED_MODULE_2_classnames___default()(prefixCls + '-digit-item', prefixCls + '-action-bg');
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'ul',
        { className: prefixCls + '-stock-key', key: 'stock-key' },
        keyboardStockItems.map(function (item, index) {
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
            {
              component: 'li',
              key: item + '-' + index,
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
          { component: 'li', className: actionCls, onTap: _this.handleKeyboardSwitchTap(_this.keyboardTypes.LETTER) },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            null,
            'ABC'
    ...
    _this.renderDigitKey = function () {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'ul',
        { className: prefixCls + '-digit-key ' + prefixCls + '-digit-' + type, key: 'digit-key' },
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
          { component: 'li', className: prefixCls + '-digit-item', onTap: _this.handleHideKeyboardTap },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: prefixCls + '-packUpIcon' })
        )
      );
    };
    ...
    _this.renderOperatorKey = function () {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'ul',
        { className: prefixCls + '-operator-key', key: 'operator-key' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
          { component: 'li', className: prefixCls + '-action-bg ' + prefixCls + '-action-image', onTap: _this.handleDeleteTap },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            null,
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: prefixCls + '-deleteIcon' })
          )
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
          { component: 'li', className: prefixCls + '-action-bg', onTap: _this.handleHideKeyboardTap },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            null,
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    _this.renderLetterKeyboard = function () {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'ul',
        { className: prefixCls + '-letterKey', key: 'letterKey' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'ul',
          { className: prefixCls + '-flex-center' },
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'ul',
          { className: prefixCls + '-flex-center ' + prefixCls + '-letter-gap' },
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'ul',
          { className: prefixCls + '-flex-center ' + prefixCls + '-letter-gap ' + prefixCls + '-letter-thirdLine' },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
            { component: 'div', className: prefixCls + '-operator-item ' + prefixCls + '-operator-item-width ' + prefixCls + '-action-image', onTap: _this.handleLetterSwitchTap },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: isLowerCase ? prefixCls + '-lowerCaseIcon' : prefixCls + '-upperCaseIcon' })
          ),
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
            { component: 'div', className: prefixCls + '-operator-item ' + prefixCls + '-operator-item-width ' + prefixCls + '-action-image', onTap: _this.handleDeleteTap },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: prefixCls + '-deleteIcon' })
          )
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'ul',
          { className: prefixCls + '-flex-center ' + prefixCls + '-letter-gap ' + prefixCls + '-letter-forthLine' },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
            { component: 'li', className: prefixCls + '-operator-item ' + prefixCls + '-operator-item-width', onTap: _this.handleKeyboardSwitchTap(_this.keyboardTypes.DIGIT) },
            '123'
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
            { component: 'li', className: prefixCls + '-operator-item ' + prefixCls + '-space', onTapEnd: _this.handleKeyboardTouch(' ') },
            'space'
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_4__react_tappable_Tappable___default.a,
            { component: 'li', className: prefixCls + '-operator-item ' + prefixCls + '-operator-item-width ' + prefixCls + '-action-image', onTap: _this.handleHideKeyboardTap },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: prefixCls + '-packUpIcon' })
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'li',
            { className: prefixCls + '-operator-item ' + prefixCls + '-confirm' },
            '\u786E\u5B9A'
          )
        )
      );
  ...
  _createClass(Keyboard, [{
    ...
    value: function render() {
      ...
      var clsName = __WEBPACK_IMPORTED_MODULE_2_classnames___default()(prefixCls, (_classnames = {}, _defineProperty(_classnames, prefixCls + '-keyboard', true), _defineProperty(_classnames, prefixCls + '-hideKeyboard', !this.state.showKeyboard), _classnames));

      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'section',
        { className: clsName, id: 'keyboard' },
...
Keyboard.propTypes = {
  prefixCls: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string, //自定义类
  type: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOf(['number', 'stock', 'letter']), //标志键盘的类型
  showKeyboard: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  onPress: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired, //点击操作
  onDelete: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired, //删除操作
  onHide: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func, //隐藏密码键盘后的回调函数
  scrollHide: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool, //滑动页面，则收起键盘
  onScroll: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func //页面滑动回调函数
};
...
// module
exports.push([module.i, ".cefc-keyboard-keyboard{display:flex;position:fixed;bottom:0;left:0;width:100%;z-index:4;font-size:.14rem;background-color:#1f262f}.cefc-keyboard-keyboard .cefc-keyboard-digit-number{width:80%}.cefc-keyboard-keyboard .cefc-keyboard-digit-stock{width:60%}.cefc-keyboard-keyboard .cefc-keyboard-digit-key>li{width:33.33%;height:.54rem;padding-right:1px;padding-bottom:1px}.cefc-keyboard-keyboard .cefc-keyboard-digit-key>li:nth-child(n+10){padding-bottom:0}.cefc-keyboard-keyboard .cefc-keyboard-operator-key{display:flex;align-items:center;flex-direction:column;width:20%}.cefc-keyboard-keyboard .cefc-keyboard-operator-key>li{width:100%;height:1.085rem;box-sizing:border-box;display:flex;flex:1;padding-right:1px;padding-bottom:1px}.cefc-keyboard-keyboard .cefc-keyboard-operator-key>li>div{width:100%;height:100%;display:flex;justify-content:center;align-items:center;list-style:none;color:#fff;box-sizing:border-box;text-align:center}.cefc-keyboard-keyboard .cefc-keyboard-operator-key>li>div>*{display:block}.cefc-keyboard-keyboard .cefc-keyboard-operator-key>li+li{padding-bottom:0}.cefc-keyboard-keyboard .cefc-keyboard-letterKey{width:100%;height:100%;margin-top:.1rem;margin-bottom:.05rem}.cefc-keyboard-keyboard .cefc-keyboard-letterKey>ul div,.cefc-keyboard-keyboard .cefc-keyboard-letterKey>ul li{width:.32rem;height:.42rem;text-align:center;line-height:.42rem;color:#fff;border-radius:.05rem;box-shadow:0 0 .01rem rgba(0,0,0,.35);background-color:#3a424b}.cefc-keyboard-keyboard .cefc-keyboard-letterKey>ul li+li{margin-left:.05rem}.cefc-keyboard-keyboard .cefc-keyboard-letterKey .cefc-keyboard-letter-gap{margin-top:.12rem}.cefc-keyboard-keyboard .cefc-keyboard-letterKey .cefc-keyboard-operator-item{background-color:#35475c}.cefc-keyboard-keyboard .cefc-keyboard-letterKey .cefc-keyboard-operator-item-width{width:.42rem}.cefc-keyboard-keyboard .cefc-keyboard-letterKey .cefc-keyboard-letter-thirdLine>div:first-child{margin-right:.14rem}.cefc-keyboard-keyboard .cefc-keyboard-letterKey .cefc-keyboard-letter-thirdLine>div:last-child{margin-left:.14rem}.cefc-keyboard-keyboard .cefc-keyboard-letterKey .cefc-keyboard-letter-forthLine .operator-item{width:.41rem}.cefc-keyboard-keyboard .cefc-keyboard-letterKey .cefc-keyboard-letter-forthLine .cefc-keyboard-space{width:1.82rem}.cefc-keyboard-keyboard .cefc-keyboard-letterKey .cefc-keyboard-letter-forthLine .cefc-keyboard-confirm{width:.88rem}.cefc-keyboard-keyboard .cefc-keyboard-digit-item{width:100%;height:20%;box-sizing:border-box;float:left;display:block}.cefc-keyboard-keyboard .cefc-keyboard-digit-item>div{width:100%;height:100%;display:flex;justify-content:center;align-items:center;list-style:none;background:#3a424b;color:#fff;box-sizing:border-box;text-align:center}.cefc-keyboard-keyboard .cefc-keyboard-digit-item .cefc-keyboard-packUpIcon{display:flex;width:100%;height:100%;background:url(" + __webpack_require__(11) + ") no-repeat;background-size:.24rem auto;background-position:50%;background-color:#35475c}.cefc-keyboard-keyboard .cefc-keyboard-digit-item:last-child>div img{width:.24rem}.cefc-keyboard-keyboard .cefc-keyboard-stock-key{height:2.17rem;width:20%}.cefc-keyboard-keyboard .cefc-keyboard-stock-key>li{padding-right:1px;padding-bottom:0}.cefc-keyboard-keyboard .cefc-keyboard-stock-key>li:last-child{padding-bottom:0;padding-top:1px}.cefc-keyboard-keyboard .cefc-keyboard-stock-key div{position:relative;padding-left:20%;padding-right:20%;background-color:#323a43}.cefc-keyboard-keyboard .cefc-keyboard-stock-key .cefc-keyboard-stock-digit-item+.cefc-keyboard-stock-digit-item>div:after{content:\"\";position:absolute;left:20%;width:60%;top:0;height:.01rem;background-color:#1f262f}.cefc-keyboard-keyboard .cefc-keyboard-action-bg>div{background-color:#35475c}.cefc-keyboard-keyboard .cefc-keyboard-flex-center{display:flex;justify-content:center;align-items:center;list-style:none}.cefc-keyboard-keyboard .cefc-keyboard-action-image .cefc-keyboard-deleteIcon{display:flex;width:100%;height:100%;background:url(" + __webpack_require__(35) + ") no-repeat;background-size:.24rem auto;background-position:50%;display:block;background-color:#35475c}.cefc-keyboard-keyboard .cefc-keyboard-action-image .cefc-keyboard-lowerCaseIcon{display:flex;width:100%;height:100%;background:url(" + __webpack_require__(36) + ") no-repeat;background-size:.24rem auto;background-position:50%}.cefc-keyboard-keyboard .cefc-keyboard-action-image .cefc-keyboard-upperCaseIcon{display:flex;width:100%;height:100%;background:url(" + __webpack_require__(37) + ") no-repeat;background-size:.24rem auto;background-position:50%}.cefc-keyboard-keyboard .cefc-keyboard-action-image .cefc-keyboard-packUpIcon{display:flex;width:100%;height:100%;background:url(" + __webpack_require__(11) + ") no-repeat;background-size:.24rem auto;background-position:50%;background-color:#35475c}.cefc-keyboard-hideKeyboard{display:none}", ""]);
...
module.exports = __webpack_require__.p + "images/3bd386f0.keyboard-delete.png";

/***/ }),
/* 36 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "images/df39ed9d.lowerCase.png";

/***/ }),
/* 37 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "images/3fb344a6.upperCase.png";
...
var TappableMixin = __webpack_require__(40);
var getComponent = __webpack_require__(41);
var touchStyles = __webpack_require__(12);
